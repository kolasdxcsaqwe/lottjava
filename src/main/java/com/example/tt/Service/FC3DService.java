...
//    final String fc3dUrl="https://api.api68.com/QuanGuoCai/getLotteryInfo1.do?lotCode=10041";//福彩3D开奖地址
    ...
    public String cancelOrder(String id,String userId) {
        ...
        if(RedisCache.getInstance().get(userId+"fc3dcancelOrder")!=null)
        {
        ...
        {
            RedisCache.getInstance().set(userId+"fc3dcancelOrder",id);
        ...
        RedisCache.getInstance().delete(userId+"fc3dcancelOrder");
